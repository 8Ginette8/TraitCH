...
# 
# Description: Plot subfigures for Fig. 2
# 
# ###################################################################################
...
arthropoda.r = lapply(arthropoda.l, function(x) {
	rast(paste0("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_",x,".tif"))
})
arthropoda.r = sum(rast(arthropoda.r),na.rm=TRUE)
arthropoda.r[arthropoda.r%in%0] = NA
names(arthropoda.r) = "arthropoda"
	# n = 201
bryobiotina.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_bryophytes.tif")
bryobiotina.r[bryobiotina.r%in%0] = NA
names(bryobiotina.r) = "bryobiotina"
	# n = 493
ichthyofauna.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_fishes.tif")
ichthyofauna.r[ichthyofauna.r%in%0] = NA
names(ichthyofauna.r) = "ichthyofauna"
	# n = 85
fungi.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_fungi.tif")
fungi.r[fungi.r%in%0] = NA
names(fungi.r) = "fungi"
	# n = 9
lichen.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_lichens.tif")
lichen.r[lichen.r%in%0] = NA
names(lichen.r) = "lichen"
	# n = 2596
mollusca.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_molluscs.tif")
...
names(tetrapoda.r) = "tetrapoda"
	# n = 2,238
tracheophyta.r = rast("bonus_materials/x_50km_geo_ext/xs2z_taxa_ext_plants.tif")
